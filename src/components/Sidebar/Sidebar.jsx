        ...
        var links = (
            <List className={classes.list}>
                {routes.map((prop, key) => {
                                        ...
                                        {prop.views.map((prop, key) => {
                                            ...
                                            return (
                                                <ListItem key={key} className={classes.collapseItem}>
                                                    <div to={prop.path} className={navLinkClasses} onClick={() => {
                                                        history.push(prop.path);
                                                        console.log("________", history);
                                                    }}>
                            <span className={collapseItemMini}>
                              {prop.mini}
                            </span>
                    ...
                    return (
                        <ListItem key={key} className={classes.item}>
                            <NavLink to={prop.path} className={navLinkClasses} onClick={() => history.push(prop.path)}>
                                <ListItemIcon className={itemIcon}>
                                    <prop.icon/>
                                </ListItemIcon>
                                <ListItemText
